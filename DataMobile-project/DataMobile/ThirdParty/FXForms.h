...
static NSString *const FXFormFieldValidate = @"validate";  // Modified by MUKAI Takeshi in 2015-10
...
@property (nonatomic, readonly) BOOL validate;  // Modified by MUKAI Takeshi in 2015-10
