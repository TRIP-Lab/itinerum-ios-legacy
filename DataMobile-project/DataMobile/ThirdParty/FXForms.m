...
//#pragma clang diagnostic ignored "-Wreceiver-is-weak"  // Modified by MUKAI Takeshi in 2017-11
...
- (void)setTableView:(UITableView *)tableView
{
    ...
    // Modified by MUKAI Takeshi in 2016-07
    // set separatorColor
    self.tableView.separatorColor = [UIColor colorWithRed:239.0/255.0 green:239.0/255.0 blue:244.0/255.0 alpha:1.0];
    // set tintColor
    self.tableView.tintColor = [UIColor colorWithRed:53.0/255.0 green:112.0/255.0 blue:251.0/255.0 alpha:1.0];
...
//        return [[cellClass alloc] initWithStyle:style reuseIdentifier:NSStringFromClass(cellClass)];
        ...
        if ([[field valueForKey:FXFormFieldValidate]isEqual:@YES]) {
            // Modified by MUKAI Takeshi in 2016-07
            // set textColor of textLabel - if required field is not selected
//            cell.textLabel.textColor = [UIColor colorWithRed:1.0 green:0 blue:0 alpha:0.7];
            cell.textLabel.textColor = [UIColor colorWithRed:252.0/255.0 green:83.0/255.0 blue:109.0/255.0 alpha:1.0];
        }else{
            // Modified by MUKAI Takeshi in 2016-07
            // set textColor of textLabel
...
//        self.textLabel.font = [UIFont boldSystemFontOfSize:17];
        self.textLabel.font = [UIFont fontWithName:@"AvenirNext-Medium" size:16];
        FXFormLabelSetMinFontSize(self.textLabel, FXFormFieldMinFontSize);

        // set font of detailTextLabel
//        self.detailTextLabel.font = [UIFont systemFontOfSize:17];
        self.detailTextLabel.font = [UIFont fontWithName:@"AvenirNext-Medium" size:16];
        self.detailTextLabel.textColor = [UIColor colorWithRed:53.0/255.0 green:112.0/255.0 blue:251.0/255.0 alpha:1.0];
...
//    self.textField.font = [UIFont systemFontOfSize:self.textLabel.font.pointSize];
    self.textField.font = [UIFont fontWithName:@"AvenirNext-Medium" size:16];
...
//    self.textField.textColor = [UIColor colorWithRed:0.275f green:0.376f blue:0.522f alpha:1.000f];
    self.textField.textColor = [UIColor colorWithRed:53.0/255.0 green:112.0/255.0 blue:251.0/255.0 alpha:1.0];
...
- (void)setUp
{
    ...
    // Modified by MUKAI Takeshi in 2016-07
    // set stepper tintColor
    stepper.tintColor = [UIColor colorWithRed:53.0/255.0 green:112.0/255.0 blue:251.0/255.0 alpha:1.0];
}
